        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="activate">Filling Station</label>
            ...
            <div class="col-sm-6">
                <div class="form-group"><b>Logo</b><br>
                    <label for="img-upload" class="pointer text-center" style="width:100%;">
                        ...
                        <img id="img0" src="<?php if(!empty($e_logo)){echo site_url($this->Crud->read_field('id', $e_logo, 'file', 'path'));} ?>" style="max-width:100%;" />
            ...
            <div class="col-sm-6">
                <div class="form-group"><b>Picture</b><br>
                    <label for="img-uploads" class="pointer text-center" style="width:100%;">
                        ...
                        <img id="img1" src="<?php if(!empty($e_img)){echo site_url($this->Crud->read_field('id', $e_img, 'file', 'path'));} ?>" style="max-width:100%;" />
                        <span class="btn btn-danger btn-block no-mrg-btm">Choose Image</span>
