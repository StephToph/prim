                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <?php $all_rec = $this->Crud->filter_staff('', '', $log_id, '', '', '');
                                    if(!empty($all_rec)) { $counts = count($all_rec); } else { $counts = 0; }
                                    ?>
                                <p>You have total <?=$counts;?> staff.</p>
                            </div>
                                ...
                                <div class="toggle-expand-content" data-content="more-options">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            <div class="drodown">
                                                <a href="javascript:;" class="btn btn-icon btn-lg btn-primary pop" pagetitle="Add" pagesize="modal-md" pagename="<?=site_url('accounts/staff/manage'); ?>"><em class="icon ni ni-plus-c"></em></a>   
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <select class="form-control js-select2" data-toggle="js-select2" name="status" id="status" onchange="load('', '')">
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'accounts/staff/load' + methods,
            type: 'post',
