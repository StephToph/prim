...
<?php echo $this->section('content'); ?>
    <div class="main-content">
        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-2 m-b-5">
                <a href="javascript:;" class="float-right btn btn-block btn-primary pop" pageTitle="Add" pageName="<?php echo base_url('accounts/parents/manage'); ?>" pageSize="modal-lg">
        ...
        <div id="filter_box" class="row" style="display:none;">
            ...
            <div class="col-12 col-sm-4 m-b-5">
                <select id="ban" class="selects2 m-t-5" onchange="load('', '')">
                    <option value="all">Account Status</option>
                    <option value="0">Account Active</option>
                    <option value="1">Account Banned</option>
                </select>
            </div>
    ...
    <script>
        ...
        function load(x, y) {
            ...
            $.ajax({
                url: site_url + 'accounts/parents/load' + methods,
                type: 'post',
