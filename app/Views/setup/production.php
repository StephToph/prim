                ...
                <div class="card">
                    <div class="card-body">
                        <h4>
                            ...
                            <?php if($role_c) { ?>
                            <a href="javascript:;" class="float-right btn btn-primary pop" pageTitle="Add Production" pageName="<?php echo base_url('setup/production/manage'); ?>" pageSize="modal-md">
                        ...
                        <div class="row">
                            <div class="col-sm-12 table-responsive">
                                <table id="age-table" class="table table-striped table-bordered" style="width:100%;">
                                    ...
                                    <tbody><?php echo $productions; ?></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
