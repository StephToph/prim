...
<?php echo form_open_multipart($form_link, array('id'=>'bb_ajax_form', 'class'=>'')); ?>
    ...
    <?php if($param2 == 'delete') { ?>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <input type="hidden" name="d_age_id" value="<?php if(!empty($d_id)){echo $d_id;} ?>" />
            </div>
    ...
    <?php if($param2 == 'edit' || $param2 == '') { ?>
        ...
        <input type="hidden" name="age_id" value="<?php if(!empty($e_id)){echo $e_id;} ?>" />

        <div class="row">

            <div class="col-sm-12">
                <div class="form-group">
                    <label for="name"><span class="rq">*</span> Age Category</label>
