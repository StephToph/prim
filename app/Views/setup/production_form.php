...
<?php echo form_open_multipart($form_link, array('id'=>'bb_ajax_form', 'class'=>'')); ?>
    ...
    <?php if($param2 == 'delete') { ?>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <input type="hidden" name="d_production_id" value="<?php if(!empty($d_id)){echo $d_id;} ?>" />
            </div>
    ...
    <?php if($param2 == 'edit' || $param2 == '') { ?>
        ...
        <input type="hidden" name="production_id" value="<?php if(!empty($e_id)){echo $e_id;} ?>" />

        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="name"><span class="rq">*</span> Production</label>
            ...
            <div class="col-sm-12">
                <div style="background-color:#f6f6f6; margin:2px; padding: 15px;">
                    <div class="text-muted text-center"><b>PRODUCTION COVER</b></div>
                    <label for="img-upload" class="pointer text-center" style="width:100%;">
                        ...
                        <img id="img0" src="<?php if(!empty($e_image)){echo site_url($e_image);} else {echo site_url('assets/images/file.png');} ?>" style="max-width:100%;" />
