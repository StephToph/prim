...
<?php echo $this->section('content'); ?>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-4 m-b-5">
                <select id="status" class="selects2 m-t-5" onchange="load('', '')">
                    ...
                    <option value="0">Blog Active</option>
                    <option value="1">Blog Disabled</option>
                </select>
            </div>
            <div class="col-6 col-sm-2 m-b-5">
                <a href="javascript:;" class="float-right btn btn-block btn-primary pop" pageTitle="Add" pageName="<?php echo base_url('blog/index/manage'); ?>" pageSize="modal-lg">
    ...
    <script>
        ...
        function load(x, y) {
            ...
            $.ajax({
                url: site_url + 'blog/index/load' + methods,
                type: 'post',
